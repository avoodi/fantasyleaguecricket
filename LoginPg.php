...
<body class="">
    <div class="row m-0">
        <div class="col-12 col-lg-6 col-xl-6 text-center">
            ...
            <p><strong class="text-success">Create your own league, invite friends, play your own IPL</strong></p>
            <p class="m-0">
            ...
            <div class="row m-0">
                <div class="flex steps rounded bg-primary">
                    ...
                    <ul class="steps-font text-white">
                        ...
                        <li>Every team has one-one match with some other league everyday, earns points based on how players performed in actual IPL match</li>
