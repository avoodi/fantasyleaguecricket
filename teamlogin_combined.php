        ...
        <div class="col-12 col-lg-6 col-xl-6">
            <Form name="frmreg" class="form-register bg-primary" method="post" action="teamregister.php">
                <h1 class="h3 mb-3 font-weight-normal text-center text-white">
                    <strong class="text-uppercase">Register</strong>
								...
								<input type="text" name="userid" class="form-control mt-2" placeholder="UserID" value="" size="30">
			...
			<!--4/7/2021 #1
                ...
                <hr class="border border-white">
								...
								<select class="form-control custom-select" name="iWantTo">
										<option>Choose</option>
										<option value="Join an existnig League created by my friend" </option>
										<option value="Create a new league which my friends can join" </option>
										<option value="Join prediction game in group created by my friend" </option>
										<option value="Create a new group to play daily predicton game" </option>
								</select>
